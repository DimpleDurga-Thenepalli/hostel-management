...
function StudentDashboard() {
  ...
  const { complaintsCount, outingsCount, fee, notices } = data;

  return (
    <div>
      <h2>Student Dashboard</h2>
      <p>Welcome to your hostel overview.</p>
      <div className="grid grid-3">
        <div className="card">
          <div className="card-label">Complaints Raised</div>
          <div className="card-value">{complaintsCount}</div>
        </div>
        <div className="card">
